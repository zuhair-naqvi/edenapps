...
<th class="sf_admin_date sf_admin_list_th_last_login ui-state-default ui-th-column">
  <?php if ('last_login' == $sort[0]): ?>
    <?php /*echo link_to(__('Last login', array(), 'messages'), '@members?sort=last_login&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'), array('class' => $sort[1]))*/ ?>

    <a href="<?php echo url_for('@members?sort=last_login&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc')) ?>">
      <span class="ui-icon <?php echo ($sort[1] == 'asc' ? 'ui-icon-circle-triangle-s' : 'ui-icon-circle-triangle-n') ?>"></span>
    ...
    <?php //echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'sf_admin'), 'title' => __($sort[1], array(), 'sf_admin'))) ?>
  <?php else: ?>
    <?php /*echo link_to(__('Last login', array(), 'messages'), '@members?sort=last_login&sort_type=asc')*/ ?>

    <a href="<?php echo url_for('@members?sort=last_login&sort_type=asc') ?>">
      <span class="ui-icon ui-icon-triangle-2-n-s"></span>
      <?php echo __('Last login', array(), 'messages') ?>
    </a>
