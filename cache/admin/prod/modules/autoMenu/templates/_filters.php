...
<div class="sf_admin_filter ui-helper-reset ui-helper-clearfix" id="sf_admin_filter" title="<?php echo __('Filters')?>">
  ...
  <form action="<?php echo url_for('menu_item_collection', array('action' => 'filter')) ?>" method="post">
    <table>
      <tfoot>
        <tr>
          <td colspan="2">
            <div style="text-align:right">
              ...
              <?php echo link_to(__('Reset', array(), 'sf_admin'), 'menu_item_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' =>  'fg-button ui-state-default ui-corner-all', 'id' => 'sf_admin_filter_reset')) ?>
