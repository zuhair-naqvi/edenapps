<div class="sf_admin_list ui-grid-table ui-widget ui-corner-all ui-helper-reset ui-helper-clearfix">
  ...
  <table>
    ...
    <tbody>
      <?php foreach ($pager->getResults() as $i => $menu_item): $odd = fmod(++$i, 2) ? ' odd' : '' ?>
        <tr class="sf_admin_row ui-widget-content <?php echo $odd ?>">
                      <?php include_partial('menu/list_td_batch_actions', array('menu_item' => $menu_item, 'helper' => $helper)) ?>
          
          <?php include_partial('menu/list_td_tabular', array('menu_item' => $menu_item)) ?>

                      <?php include_partial('menu/list_td_actions', array('menu_item' => $menu_item, 'helper' => $helper)) ?>
                  </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
