 ...
 * @property integer $pseudo_parent_id
 ...
 * 
 * @method integer             getPseudoId()         Returns the current record's "pseudo_id" value
 * @method integer             getPseudoParentId()   Returns the current record's "pseudo_parent_id" value
 ...
 * @method MenuItem            setPseudoId()         Sets the current record's "pseudo_id" value
 * @method MenuItem            setPseudoParentId()   Sets the current record's "pseudo_parent_id" value
...
abstract class BaseMenuItem extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('pseudo_id', 'integer', null, array(
             'type' => 'integer',
             ));
        $this->hasColumn('pseudo_parent_id', 'integer', null, array(
             'type' => 'integer',
             ));
